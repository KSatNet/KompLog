...
namespace KompLog
{
	...
	public class KompLogStyle: MonoBehaviour
	{
		static public KompLogStyle Instance
		{
			get { return _instance; }
		}
		static private KompLogStyle _instance = null;
		...
		/// <summary>
		/// Gets the time string for a given universal time.
		/// </summary>
		...
		/// <summary>
		/// Gets the time string for a given number of seconds.
		/// </summary>
		/// <returns>The time string.</returns>
